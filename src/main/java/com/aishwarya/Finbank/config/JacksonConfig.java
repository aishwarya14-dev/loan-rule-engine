...
public class JacksonConfig {
    ...
    public ObjectMapper objectMapper() {
        ...
        // registering RuleValueDeserializer with ObjectMapper, Jackson cannot deserialize an interface RuleValue without being told which implementation to create
        // required while reading 'Rule' object from redis
