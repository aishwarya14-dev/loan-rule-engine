...
public class LoanRulesLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "APPROVE", "REJECT", "REVIEW", "GT", 
			"GE", "LT", "LE", "EQ", "NEQ", "AND", "OR", "IDENTIFIER", "NUMBER", "WS"
		};
	}
	...
	public LoanRulesLexer(CharStream input) {
		super(input);
